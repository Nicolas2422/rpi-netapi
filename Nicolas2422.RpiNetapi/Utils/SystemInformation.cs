...
namespace Nicolas2422.RpiNetapi.Utils
{
    ...
    {
        public async Task<IEnumerable<Models.Storage>> StorageInformation()
        {
        ...
        public async Task<Models.Cpu> CpuInformation()
        {
            Task<(string, string)> task = Task.Run(async () => await InternalCpuInformation());
            Task<decimal> temperature = Task.Run(async () => await InternalCpuTemperature());
            Task<int> cpuFreq = Task.Run(async () => await InternalCpuFrequency());
            Task<decimal> cpuUsage = Task.Run(async () => await InternalCpuUsage());
        ...
        public async Task<Models.Memory> MemoryInformation()
        {
        ...
        private async Task<(string, string)> InternalCpuInformation()
        {
            /* Run df cmd */
            var psi = new ProcessStartInfo
            {
        ...
        private async Task<decimal> InternalCpuTemperature()
        {
        ...
        private async Task<int> InternalCpuFrequency()
        {
            int frequency = 0;
        ...
        private async Task<decimal> InternalCpuUsage()
        {
            decimal usage = 0;
